  ...
  const features = [
    {
      icon: Clock,
      title: "Fast Response",
      description: "Average response time of 15-30 minutes. We get to you quickly when every minute matters."
    },
    {
      icon: Shield,
      title: "Safe & Verified",
      description: "All technicians are licensed, insured, and background-checked for your safety and peace of mind."
    },
    {
      icon: DollarSign,
      title: "Transparent Pricing",
      description: "No hidden fees or surprise charges. You'll know the exact cost before any work begins."
    },
    {
      icon: Users,
      title: "Trusted by Thousands",
      description: "Over 50,000 satisfied customers trust DrRoads for their roadside assistance needs."
    },
    {
      icon: Award,
    ...
    },
    {
      icon: Headphones,
      title: "24/7 Support",
      description: "Round-the-clock customer support available every day of the year, whenever you need us."
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="group hover:shadow-xl hover:shadow-yellow-500/10 transition-all duration-300 bg-card border-border/50"
              >
